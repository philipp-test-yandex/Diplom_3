...
HEADER_ON_PAGE_FEED_ORDER = (By.XPATH, "//h1[text()='Лента заказов']")

ORDER_MODAL_NUMBER = (By.CSS_SELECTOR, "p.text.text_type_digits-default.mb-10.mt-5")

FIRST_CARD_IN_FEED_LIST = (By.CSS_SELECTOR, "a.OrderHistory_link__1iNby")

HEADER_IN_MODAL_OF_FEED_ORDER = (By.XPATH, "//p[text()='Cостав']")

HEADER_ORDER_CREATED = (By.CSS_SELECTOR, "h2.text_type_digits-large")
...
UNIVERS_FIRST_INGREDIENT_FOR_DRAG_DROP = (By.CSS_SELECTOR, 'a[href^="/ingredient/"]')

DROP_TARGET = (By.CSS_SELECTOR, '.BurgerConstructor_basket__list__l9dp_')

ORDER_PRICE_TOTAL_ON_MAIN_PAGE = (By.CSS_SELECTOR, "p.text.text_type_digits-medium.mr-3")


MODAL_CLOSE_BUTTON = (By.CSS_SELECTOR, "button[class*='modal__close']")

PERSONAL_ACCOUNT_BUTTON = (By.LINK_TEXT, "Личный Кабинет")

MODAL_ORDER_CONTAINER = (By.CLASS_NAME, "Modal_modal_opened__3ISw4")
